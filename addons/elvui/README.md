...
Este addon modifica la interfaz de usuario y permite la personalización de la misma a niveles de alto detalle. 
Podremos editar desde la posición de nuestra barra de salud, minimapa o barras de acción, hasta el tamaño de las barras de salud mostradas sobre el resto de jugadores/npc o color de las mismas, pudiendo reflejar de manera visual la clase de cada aliado y/o enemigo.

### Capturas de pantalla

![Captura de pantalla de tukui: Fijadores](http://www.tukui.org/storage/images/805918WoWScrnShot_082115_122925.jpg)
> Aquí se puede observar todos los elementos del interfaz que pueden ser reubicados gracias a Elvui
...
* El addon no se puede descargar desde wowcurse, será necesario que vayas a la página oficial de tukui y busques el [Elvui](http://www.tukui.org/dl.php)
* Una vez descargado el addon, deberás dejar las carpetas `ElvUI` y `ElvUI_Config`, contenidas en el *.zip, en `C:\Program Files (x86)\World of Warcraft\Interface\AddOns\`
* Una vez hagas esto, cuando reinicies el cliente se cargará un pequeño tutorial para una configuración básica del ElvUI (Recomiendo seguir este tutorial, servirá de "preconfiguración" ya que, si no recuerdo mal, podrás determinar la resolución del monitor)
* Si queremos abrir la configuración del ElvUI deberemos pulsar ESC o escribir en el chat el comando `/elvui`.
* Para poder importar un perfil ya configurado (como los que encontraréis en esta carpeta) deberás seguir los siguientes pasos:
